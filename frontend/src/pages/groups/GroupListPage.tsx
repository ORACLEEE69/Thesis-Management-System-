    ...
    async function loadUsers() {
        try {
            ...
            try {
                ...
                const panelsData = await api.get('users/?role=PANEL');
        ...
        <Box sx={{p: 4, backgroundColor: '#F8FAFC'}}>
                            ...
                            <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3}}>
                                ...
                                <Box>
                                    ...
                                    <Typography variant="body1" color="text.secondary" sx={{mb: 3}}>
                                        You haven't joined or created any research groups yet. As a student, you can
                                        only be a member of one active research group.
                                    </Typography>
                                    <Button
                                        variant="contained"
                                        startIcon={<Add/>}
                                            ...
                                            >
                                                <TableCell component="th" scope="row">
                                                    <Box sx={{display: 'flex', alignItems: 'center'}}>
                                                        ...
                                                        <Typography variant="body1"
                                                                    sx={{fontWeight: 500}}>{group.name}</Typography>
                                                ...
                                                <TableCell>
                                                    {group.proposed_topic_title ? (
                                                        <Typography
                                                            variant="body2">{group.proposed_topic_title}</Typography>
                                                    ) : (
                                                        <Typography variant="body2" color="text.secondary">No topic
                        ...
                        <Box>
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={6}>
                                    <Typography variant="h6" sx={{color: '#1e293b', mb: 2}}>Group
                                        Information</Typography>
                                    <Box sx={{mb: 2}}>
                                        <Typography variant="body2" color="text.secondary">Group Name</Typography>
                                        <Typography variant="body1"
                                                    sx={{fontWeight: 500}}>{selectedGroup.name}</Typography>
                                    </Box>
                                    <Box sx={{mb: 2}}>
                                    ...
                                    {selectedGroup.rejection_reason && (
                                        <Box sx={{mb: 2}}>
                                            <Typography variant="body2" color="text.secondary">Rejection
                                                Reason</Typography>
                                            <Typography variant="body2"
                                                        sx={{fontStyle: 'italic'}}>{selectedGroup.rejection_reason}</Typography>
                                        </Box>
                                    )}
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    ...
                                    {selectedGroup.leader ? (
                                        <Box sx={{
                                            ...
                                            <Avatar
                                                sx={{width: 48, height: 48, fontSize: '1.2rem', bgcolor: '#10b981'}}>
                                        ...
                                        <Typography variant="body2" color="text.secondary"
                                                    sx={{mb: 3, p: 2, backgroundColor: '#f8fafc', borderRadius: 2}}>No
                                            leader assigned</Typography>
                                    )}
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    {selectedGroup.adviser ? (
                                        ...
                                        <Typography variant="body2" color="text.secondary">No adviser
                                            assigned</Typography>
                                    )}
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    ...
                                    {selectedGroup.panels && selectedGroup.panels.length > 0 ? (
                                        ...
                                        <Typography variant="body2" color="text.secondary">No panel members
                                            assigned</Typography>
                                    )}
                                </Grid>
                            </Grid>
            ...
            <Dialog open={open} onClose={() => setOpen(false)} maxWidth="sm" fullWidth>
                <Box sx={{p: 4}}>
                    ...
                    <FormControl fullWidth sx={{mb: 3}}>
                        <InputLabel>Panels</InputLabel>
                        <Select
                            value={formData.panel_ids || []}
                            multiple
                            label="Panels"
                            onChange={(e) => {
                                const raw = e.target.value as unknown as string[];
