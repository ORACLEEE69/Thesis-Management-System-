...
var Tooltip = React92.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React92.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime106.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime107.jsxs)(React92.Fragment, {
    children: [React92.cloneElement(children, childrenProps), (0, import_jsx_runtime106.jsx)(PopperComponent, _extends({
...
var ToggleButtonGroup = React127.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime146.jsx)(ToggleButtonGroupRoot, _extends({
    ...
    children: (0, import_jsx_runtime146.jsx)(ToggleButtonGroupContext_default.Provider, {
      value: context,
      children: validChildren.map((child, index) => {
        if (true) {
        ...
        return (0, import_jsx_runtime146.jsx)(ToggleButtonGroupButtonContext_default.Provider, {
          value: getButtonPositionClassName(index),
          children: child
        }, index);
      })
